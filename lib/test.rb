...
biz.create_assign project_a, member
...
p project_a, member
biz.select_between_projects Date.new(2020, 6, 11), Date.new(2020, 6, 16) #=>[project_a]
biz.select_between_assigns Date.new(2020, 6, 11), Date.new(2020, 6, 16) #=>[project_a:member]
...
biz.delete_project project_a
biz.delete_project project_b
